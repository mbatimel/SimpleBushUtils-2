...
declare -a extra=(
"-s aboba test_1_grep.txt"
"-s aboba TEST-1-grep"
"-os s test_0_grep.txt"
"-cls s test_0_grep.tx"
"-lvcs s grep_tests/test_10_grep.txt"
"-o s test_1_grep.txt "
"-in s test_1_grep.txt"
"-iv s test_1_grep.txt"
"-ie s test_1_grep.txt"
